window.addEventListener("DOMContentLoaded", function(){
	var contextmenu_menu = [
		["/users/edit", "dan_contextmenu_edit", "Редактировать"],
		["/projects/add", "dan_contextmenu_add", "Добавить проект"],
		["/users/pub", "dan_contextmenu_pub", "Активен"],
		["/users/unpub", "dan_contextmenu_unpub", "Неактивен"],
		["/users/up", "dan_contextmenu_up", "Вверх"],
		["/users/down", "dan_contextmenu_down", "Вниз"],
